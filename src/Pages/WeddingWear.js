...
const WeddingWear = () => {
  ...
  return (
    ...
    <div className="weddingwear-page">
      ...
      {/* Indian Section */}
      <section className="wear-section" ref={indianRef} data-aos="fade-up">
      ...
      {/* Kandian Section */}
      <section className="wear-section reverse" ref={kandianRef} data-aos="fade-up">
        <div className="wear-text">
          <h2>Kandian Saree</h2>
      ...
      {/* Western Section */}
      <section className="wear-section" ref={westernRef} data-aos="fade-up">
